...
export function FileUpload({ label = "Arraste e solte seu arquivo aqui", formatsText = "Formatos aceitos: CSV, XLSX. Tamanho máximo: 10MB", onPick }: { label?: string; formatsText?: string; onPick?: () => void }) {
  return (
    <div className="flex min-h-44 flex-col items-center justify-center rounded-lg border border-dashed border-noogym-lime/35 bg-noogym-lime/[0.03] p-5 text-center">
      ...
      <p className="mt-2 text-xs text-zinc-400">{formatsText}</p>
